...
import BehindScenesGlobalView from "@/app/components/behind-scenes/BehindScenesGlobalView";

export const dynamic = "force-dynamic";

export default async function BehindScenesPage() {
  ...
  return <BehindScenesGlobalView companyId={companyId} projects={projects ?? []} episodes={episodes ?? []} />;
}
