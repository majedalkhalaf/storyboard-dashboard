...
export default function NotificationsBell() {
  ...
  async function openNotification(n: AppNotification) {
    ...
    if (n.project_id) {
      router.push(
        n.episode_id ? `/projects/${n.project_id}/episodes/${n.episode_id}` : `/projects/${n.project_id}`
      );
    }
  }
  ...
  return (
    <div style={{ position: "relative" }}>
      <button className="btn btn-ghost" onClick={() => setOpen((v) => !v)} style={{ position: "relative" }}>
      ...
      {open && (
        <>
          ...
          <div
            ...
            style={{ position: "absolute", top: "calc(100% + 8px)", left: 0, width: 320, maxHeight: 420, overflowY: "auto", zIndex: 100, padding: 0 }}
          >
