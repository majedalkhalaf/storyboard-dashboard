...
export default function OAuthButtons({ label }: { label: string }) {
  ...
  async function handleOAuth(provider: Provider) {
    ...
    if (oauthError) {
      ...
      setError("تعذّر الدخول بهذه الطريقة، تأكد من تفعيلها في إعدادات النظام");
    }
  }
  ...
  return (
    <div>
      ...
      {error && (
        <div style={{ color: "#ef4444", fontSize: 12, display: "flex", alignItems: "center", gap: 6, marginTop: 10 }}>
